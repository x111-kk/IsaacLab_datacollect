...
"""Pink-IK + OpenXR teleop configuration for the GR1T2 pour-water task."""
...
@configclass
class PourWaterGR1T2PinkIKEnvCfg(PourWaterGR1T2BaseEnvCfg):
    """GR1T2 pour-water environment configured with Pink-IK absolute control."""
